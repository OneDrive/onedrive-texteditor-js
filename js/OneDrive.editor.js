var markdownEditor = {
    ...
    openItemInEditor: function (fileItem) {
        var downloadLink = this.downloadPrefix + fileItem["@content.downloadUrl"];
    ...
    saveFile: function () {
        ...
        if (this.baseUrl.endsWith("/me")) {
            this.baseUrl = this.baseUrl.substring(0, this.baseUrl.length - 2);
        }

        var url = this.baseUrl + "drive/items/" + this.openFileID + "/content";
    ...
    // The base OneDrive URL to reference, auto populated when a file is opened.
    baseUrl: "",
    ...
    // We're working around it by using a cors-proxy for DEMO PURPOSES ONLY but
    // will remove this hack when the bug is fixed.
    downloadPrefix: "https://crossorigin.me/"
}
