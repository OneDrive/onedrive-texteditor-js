var markdownEditor = {
    ...
    openItemInEditor: function (fileItem) {
        // There's a bug where ODB doesn't allow CORS access to downloadUrl.
        // We're working around it by using a cors-proxy for demo purposes but
        // will remove this hack when the bug is fixed.
        var downloadLink = "https://crossorigin.me/" + fileItem["@content.downloadUrl"];
